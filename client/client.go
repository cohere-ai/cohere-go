...
import (
	...
	connectors "github.com/cohere-ai/cohere-go/v3/connectors"
	core "github.com/cohere-ai/cohere-go/v3/core"
	datasets "github.com/cohere-ai/cohere-go/v3/datasets"
	embedjobs "github.com/cohere-ai/cohere-go/v3/embedjobs"
	finetuningclient "github.com/cohere-ai/cohere-go/v3/finetuning/client"
	internal "github.com/cohere-ai/cohere-go/v3/internal"
	models "github.com/cohere-ai/cohere-go/v3/models"
	option "github.com/cohere-ai/cohere-go/v3/option"
	v2 "github.com/cohere-ai/cohere-go/v3/v2"
	http "net/http"
	os "os"
)
...
func (c *Client) ChatStream(
	ctx context.Context,
	request *v3.ChatStreamRequest,
	opts ...option.RequestOption,
) (*core.Stream[v3.StreamedChatResponse], error) {
	options := core.NewRequestOptions(opts...)
	...
	streamer := internal.NewStreamer[v3.StreamedChatResponse](c.caller)
...
func (c *Client) Chat(
	ctx context.Context,
	request *v3.ChatRequest,
	opts ...option.RequestOption,
) (*v3.NonStreamedChatResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	var response *v3.NonStreamedChatResponse
...
func (c *Client) GenerateStream(
	ctx context.Context,
	request *v3.GenerateStreamRequest,
	opts ...option.RequestOption,
) (*core.Stream[v3.GenerateStreamedResponse], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	streamer := internal.NewStreamer[v3.GenerateStreamedResponse](c.caller)
	return streamer.Stream(
		ctx,
		&internal.StreamParams{
			URL:             endpointURL,
...
func (c *Client) Embed(
	ctx context.Context,
	request *v3.EmbedRequest,
	opts ...option.RequestOption,
) (*v3.EmbedResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
...
func (c *Client) Rerank(
	ctx context.Context,
	request *v3.RerankRequest,
	opts ...option.RequestOption,
) (*v3.RerankResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	var response *v3.RerankResponse
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
...
func (c *Client) Classify(
	ctx context.Context,
	request *v3.ClassifyRequest,
	opts ...option.RequestOption,
) (*v3.ClassifyResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	var response *v3.ClassifyResponse
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
...
func (c *Client) Summarize(
	ctx context.Context,
	request *v3.SummarizeRequest,
	opts ...option.RequestOption,
) (*v3.SummarizeResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	var response *v3.SummarizeResponse
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
...
func (c *Client) Tokenize(
	ctx context.Context,
	request *v3.TokenizeRequest,
	opts ...option.RequestOption,
) (*v3.TokenizeResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	var response *v3.TokenizeResponse
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
...
func (c *Client) Detokenize(
	ctx context.Context,
	request *v3.DetokenizeRequest,
	opts ...option.RequestOption,
) (*v3.DetokenizeResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	var response *v3.DetokenizeResponse
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
...
func (c *Client) CheckApiKey(
	...
	var response *v3.CheckApiKeyResponse
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
