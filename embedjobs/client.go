...
func (c *Client) List(
	...
	var response *v3.ListEmbedJobResponse
...
func (c *Client) Create(
	ctx context.Context,
	request *v3.CreateEmbedJobRequest,
	opts ...option.RequestOption,
) (*v3.CreateEmbedJobResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	var response *v3.CreateEmbedJobResponse
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
