...
func (c *Client) ChatStream(
...
) (*core.Stream[v3.StreamedChatResponseV2], error) {
	options := core.NewRequestOptions(opts...)
	...
	streamer := internal.NewStreamer[v3.StreamedChatResponseV2](c.caller)
