...
func (a *AssistantMessageContentItem) GetText() *ChatTextContent {
	if a == nil {
		return nil
	}
	return a.Text
...
type SystemMessageV2 struct {
	Content *SystemMessageV2Content `json:"content,omitempty" url:"content,omitempty"`
...
type UserMessageV2 struct {
	...
	Content *UserMessageV2Content `json:"content,omitempty" url:"content,omitempty"`
